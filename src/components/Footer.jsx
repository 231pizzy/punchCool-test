...
export default function Footer({ scrollToTop }) {
    ...
    return (<div>
        ...
        <div className='lg:max-w-[1300px] max-w-[400px] md:max-w-[800px] md:h-[320px] h-[300px] lg:h-[481px] mb-4 lg:mb-6 mt-8 flex justify-center items-center lg:ml-10' style={{ backgroundColor: 'rgba(82, 90, 160, 1)', transform: 'skewY(-1deg)', transformOrigin: 'top left' }}>
            <div style={{ transform: 'skewY(1deg)', transformOrigin: 'top left', color: "rgba(255, 255, 255, 1)", alignContent: "center", alignItems: "center" }}>
                <div className={`font-switzer lg:text-[54px] md:text-[30px] text-[18px] lg:leading-[64px] md:leading-[44px] leading-[24px] lg:h-[128px] md:h-[90px] h-[50px] w-[250px] lg:w-[683px] md:w-[400px] text-center ${isVisible ? 'ml-12' : 'ml-2'}  md:ml-0`}>
                    <h1>Need a job done, and done well? Get started</h1>
                </div>

                {isVisible && (
                    <div className='lg:h-[128px] md:h-[90px] h-[50px] w-[300px] lg:w-[683px] md:w-[400px] lg:mt-4'>
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <div style={{ flex: 1, marginBottom: '20px', backgroundColor: 'transparent', marginRight: '10px' }}>
                                <input
                                    type="text"
                                    placeholder="Enter your name"
                                    style={{ width: '100%', border: 'none', borderBottom: '1px solid rgba(255, 255, 255, 1)',
                                        outline: 'none', fontSize: '16px', padding: '5px 0', backgroundColor: 'transparent',
                                        color: '#000',}}className='text-[12px]'/>
                            </div>
                            <div style={{ flex: 1, marginBottom: '20px', backgroundColor: 'transparent', marginLeft: '10px' }}>
                                <input type="text" placeholder="Enter your email" style={{width: '100%', border: 'none', borderBottom: '1px solid rgba(255, 255, 255, 1)', outline: 'none', fontSize: '16px', padding: '5px 0', backgroundColor: 'transparent', color: '#000',
                                    }}
                                />
                            </div>
                        </div>
                        <div style={{ position: 'relative', marginBottom: '20px', backgroundColor: 'transparent' }}>
                            <input type="text" placeholder="Enter your message"
                                style={{width: '100%',border: 'none', borderBottom: '1px solid rgba(255, 255, 255, 1)',
                                    outline: 'none',fontSize: '16px', padding: '15px 0',backgroundColor: 'transparent',
                ...
                <div
                   className={`lg:h-[73.73px] md:h-[58.73px] h-[48.73px] w-[48.73px] lg:w-[73.73px] md:w-[58.73px] mx-auto lg:mt-10  ${isVisible ? 'mt-20' : 'mt-4'} md:mt-10 flex justify-center items-center`}
                    style={{ backgroundColor: "rgba(32, 34, 41, 1)", borderRadius: "29.89px", cursor: 'pointer' }}
