            ...
            <nav style={{ height: "60px", borderRadius: "15px", backgroundColor: "rgba(82, 90, 160, 1)", boxShadow: "0px 15px 25px 0px rgba(0, 0, 0, 0.15)", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 20px" }}>
                ...
                {!open && (
                    <div
                        ...
                        className={`z-[999] text-white text-3xl sm:hidden cursor-pointer`}
                ...
                >
                    {/* Close Icon - shown only when menu is open */}
                    {open && (
                        <div
                            onClick={() => setOpen(false)}
                            className="close-icon text-4xl text-gray-900 cursor-pointer absolute left-4 top-4 ml-6 mt-6"
                        >
