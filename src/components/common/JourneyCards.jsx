      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', }}>
        <div className='w-[520px] lg:mt-14 lg:ml-4 ml-0 mt-4 md:ml-2 md:mt-6' style={{ transform: 'skewY(1.8deg)', transformOrigin: 'top left', display: "flex" }}>
          ...
          <div className='ml-2 lg:ml-6 md:ml-4'>
            <div className='lg:h-[88px] lg:w-[445px] w-[200px] md:w-[300px] lg:mb-6 mb-1 md:mb-2'>
              <h1 style={{ fontWeight: "600", color: "rgba(32, 34, 41, 1)" }} className='text-[12px] md:text-[24px] lg:text-[34px] lg:leading-[44px] leading-[25px] md:leading-[32px] font-switzer'>{title}</h1>
            </div>
            <div className='lg:h-[48px] lg:w-[407px] w-[180px] h-[30px] md:w-[240px] md:h-[38px]'>
              <p style={{ fontWeight: "400", color: "rgba(32, 34, 41, 0.8)" }} className='text-[10px] md:text-[16px] lg:text-[16px] lg:leading-[24px] leading-[16px] md:leading-[24px] font-switzer mb-2'>{data}</p>
            </div>
            {/* Button */}
